...
<!--
**AryanDhuri/AryanDhuri** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
I’m a first-year BCA student at **NITTE Institute of Professional Education**. Passionate about technology and always eager to learn, I aspire to become a **Cloud Engineer** in the future. 🌥️

## 🎓 Education
- **BCA (Bachelor of Computer Applications)** - NITTE Institute of Professional Education
- Currently studying programming languages such as **C**, **Java**, and **Python**.

## 💻 Skills & Technologies
- **Languages:** C, Java, Python
- **Cloud Technologies (Aspiring):** AWS, Azure, Google Cloud (Learning)
- **Tools:** Git, GitHub, IDEs (IntelliJ, Visual Studio Code)

## 🚀 Current Focus
- Learning **Java** and **Python** to enhance my coding skills.
- Exploring **cloud technologies** and aiming to work on cloud-based projects in the near future.
...
## About Me 🚀
<p align="justify">
I'm a **BCA student** passionate about **Cloud Computing, Java, and C Programming**. I love exploring new technologies and working on exciting projects. 🚀
<!--
